...
dc-build:
	docker-compose -f config/docker/compose-gateway.yaml -f config/docker/compose-mesh.yaml -f config/docker/compose-proxy.yaml --project-directory . build

dc-down:
	docker-compose -f config/docker/compose-gateway.yaml -f config/docker/compose-mesh.yaml -f config/docker/compose-proxy.yaml --project-directory . down
