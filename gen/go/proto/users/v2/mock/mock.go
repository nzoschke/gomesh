...
// Source: gen/go/proto/users/v2/users.pb.go
...
func (m *MockUsersClient) Create(ctx context.Context, in *x.CreateRequest, opts ...grpc.CallOption) (*x.User, error) {
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
// Create mocks base method
func (m *MockUsersServer) Create(arg0 context.Context, arg1 *x.CreateRequest) (*x.User, error) {
