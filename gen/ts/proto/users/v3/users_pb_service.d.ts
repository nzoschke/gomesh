...
import * as proto_users_v3_users_pb from "../../../proto/users/v3/users_pb";
...
type UsersGet = {
  ...
  readonly requestType: typeof proto_users_v3_users_pb.GetRequest;
  readonly responseType: typeof proto_users_v3_users_pb.User;
};
...
export class UsersClient {
  ...
  get(
    requestMessage: proto_users_v3_users_pb.GetRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: proto_users_v3_users_pb.User|null) => void
  ): void;
  get(
    requestMessage: proto_users_v3_users_pb.GetRequest,
    callback: (error: ServiceError|null, responseMessage: proto_users_v3_users_pb.User|null) => void
